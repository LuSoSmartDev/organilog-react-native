...
import { FlatList, StyleSheet, Platform, Image, DeviceEventEmitter, Alert } from 'react-native'
import {
  Container,
  View,
  Header,
      ...
      <Container>
        ...
        <Footer style={styles.footer}>
          {/* <Button
            full
            style={styles.btnAdd}
            onPress={() => Actions.listCategoryTracking()}
          >
            <Text style={styles.btnAddText}>
              {I18n.t('CATE_TRACKING')}
            </Text>
          </Button> */}
          
          <Button
            full
            style={styles.btnAddLeft}
            marginLeft={20}
            onPress={() => Alert.alert('', I18n.t('OTHER_TRACKING_VALID'), [
          ...
          >
           <Icon1 name='barcode-scan' size={30} color='white'/>
          </Button>

           <Button
            full
            style={styles.btnAddRight}
            marginLeft={20}
            onPress={() =>{
                 Alert.alert('', I18n.t('OTHER_TRACKING_VALID'), [
                  { text: I18n.t('CANCEL'), onPress: () => { } },
                  {
                    text: I18n.t('VALIDATE'),
                    onPress: () => {
                      Actions.listCategoryTracking()
                    },
                  },
                ])
          ...
          >
          <Icon name='touch-app' size={30} color='white'/>
          </Button>
